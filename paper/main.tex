...
assumptions are stated. Such a practice is especially important when the
...
$\R$, a distance on $\Theta$ satisfying $5$ properties as well as a
cancellativity condition and a kernel $K : X \times X \to \R$ with
Calder\'on-Zygmund like properties. The proofs fix even more additional data,
notably two bounded measurable sets $F$ and $G$, an integrability exponent $q
\in (1, 2]$,
